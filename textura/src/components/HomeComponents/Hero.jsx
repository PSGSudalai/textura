  ...
  return (
    <div id="home-1" className="homepage-slides owl-carousel">
      ...
      <div
        ...
        style={{ backgroundImage: "url('assets/img/project/1.jpg')" }}
      >
        ...
        <div className="hero-area-content">
          <div className="container">
            <div className="row align-items-center">
              ...
              >
                <div className="section-title">
                  <h6 className="text-white">Durable Design</h6>
                  <h1 className="text-white">
                    <span>Textura</span> Export: Your <br /> Foundation For
                    Style
                  </h1>
                </div>
                <p className="text-white">
      ...
      <div
        className="single-slide-item d-flex align-items-center"
        style={{ backgroundImage: "url('assets/img/slider/3-1.jpg')" }}
      >
        <div className="overlay-4"></div>
        <div className="hero-area-content">
          <div className="container">
